...
DATABASES = {
    'default': {
        ...
        'NAME': 'planamodb',                      # Or path to database file if using sqlite3.
        'USER': 'postgres',                      # Not used with sqlite3.
        'PASSWORD': 'andyfang',                  # Not used with sqlite3.
...
SECRET_KEY = 'c*g$d)y5+*rk$ox1@n5965x#qx*vh^s%t9iyc(-okt0&+!_9@p'
